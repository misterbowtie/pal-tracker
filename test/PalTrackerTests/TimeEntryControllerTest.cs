...
namespace PalTrackerTests
{
    public class TimeEntryControllerTest
    {
        ...
        private readonly Mock<IOperationCounter<TimeEntry>> _opCounter;

        public TimeEntryControllerTest()
        {
            _repository = new Mock<ITimeEntryRepository>();
            _opCounter = new Mock<IOperationCounter<TimeEntry>>();
            _controller = new TimeEntryController(_repository.Object, _opCounter.Object);

            _opCounter.Setup(oc => oc.Increment(It.IsAny<TrackedOperation>()));
        }
        ...
        public void Read()
        {
            ...
            _opCounter.Verify(oc => oc.Increment(TrackedOperation.Read), Once);
        }
        ...
        public void Create()
        {
            ...
            _opCounter.Verify(oc => oc.Increment(TrackedOperation.Create), Once);
        }
        ...
        public void List()
        {
            ...
            _opCounter.Verify(oc => oc.Increment(TrackedOperation.List), Once);
        }
        ...
        public void Update()
        {
            ...
            _opCounter.Verify(oc => oc.Increment(TrackedOperation.Update), Once);
        }
        ...
        public void Delete()
        {
            ...
            _opCounter.Verify(oc => oc.Increment(TrackedOperation.Delete), Once);
        }
